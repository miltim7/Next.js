export default function Services() {
    return (
      <div className="bg-gray-100">
          ...
          {[
            {
              ...
              icon: 'services/life-insurance.png',
            },
            {
              title: 'Shopping',
              description: 'Buy. Think. Grow.',
              icon: 'services/shopping.png',
            },
            {
              title: 'Safety',
              description: 'We are your allies',
              icon: 'services/safety.png',
            },
          ].map(({ title, description, icon }, i) => (
            <div key={i} className="bg-white rounded-2xl flex items-center p-4">
              <img
                src={icon}
                alt={title}
                className="object-contain w-[clamp(30px,6vw,60px)] h-[clamp(30px,6vw,60px)] mr-4"
              />
              <div>
                <h3 className="text-[#232323] font-semibold text-[clamp(14px,2vw,18px)]">
                  {title}
                </h3>
                <p className="text-[#718EBF] text-[clamp(12px,2vw,16px)]">
                  {description}
                </p>
              </div>
            </div>
        ...
        <h2 className="text-[clamp(20px,4vw,22px)] font-semibold text-[#333B69] mb-4">
          Bank Services List
        </h2>
          ...
          {[
            {
              ...
              image: (
                <div className="w-[clamp(40px,10vw,50px)] h-[clamp(40px,10vw,50px)] bg-pink-100 rounded-2xl flex items-center justify-center">
                  <img
                    src="services/business-loans.png"
                    className="w-[clamp(20px,5vw,30px)] h-[clamp(20px,5vw,30px)]"
                  />
                </div>
              ),
            },
            {
              ...
              image: (
                <div className="w-[clamp(40px,10vw,50px)] h-[clamp(40px,10vw,50px)] bg-yellow-100 rounded-2xl flex items-center justify-center">
                  <img
                    src="services/checking-accounts.png"
                    className="w-[clamp(20px,5vw,30px)] h-[clamp(20px,5vw,30px)]"
                  />
                </div>
              ),
            },
            {
              ...
              image: (
                <div className="w-[clamp(40px,10vw,50px)] h-[clamp(40px,10vw,50px)] bg-red-100 rounded-2xl flex items-center justify-center">
                  <img
                    src="services/savings-accounts.png"
                    className="w-[clamp(20px,5vw,30px)] h-[clamp(20px,5vw,30px)]"
                  />
                </div>
              ),
            },
            {
              ...
              image: (
                <div className="w-[clamp(40px,10vw,50px)] h-[clamp(40px,10vw,50px)] bg-blue-100 rounded-2xl flex items-center justify-center">
                  <img
                    src="services/debit-credit-cards.png"
                    className="w-[clamp(20px,5vw,30px)] h-[clamp(20px,5vw,30px)]"
                  />
                </div>
              ),
            },
            {
              ...
              image: (
                <div className="w-[clamp(40px,10vw,50px)] h-[clamp(40px,10vw,50px)] bg-teal-100 rounded-2xl flex items-center justify-center">
                  <img
                    src="services/life-insurance2.png"
                    className="w-[clamp(20px,5vw,30px)] h-[clamp(20px,5vw,30px)]"
                  />
                </div>
              ),
            ...
            >
              <div className="flex items-center gap-4">
                {image}
                <div>
                  <p className="text-[#333B69] font-semibold text-[clamp(14px,3vw,16px)]">
                    {title}
                  </p>
                  <p className="text-[#718EBF] text-[clamp(12px,2.5vw,14px)]">
                    {description}
                  </p>
                </div>
              </div>
                ...
                {Array(3)
                  ...
                  .map((_, idx) => (
                    <div key={idx} className="flex flex-col">
                      <p className="text-[clamp(12px,2.5vw,14px)] text-[#333B69]">
                        Lorem Ipsum
                      </p>
                      <p className="text-[clamp(12px,2.5vw,14px)] text-[#718EBF]">
                        Many publishing
                      </p>
                    </div>
                  ))}
